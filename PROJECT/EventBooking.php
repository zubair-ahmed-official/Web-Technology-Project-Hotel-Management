...
<tr><td align="right"><b>Event Name:</b></td><td>&nbsp;<input type="text" name= "ename" onfocusout="checkEventname(this)" value = "<?php echo $_COOKIE["ename"]; ?>"><span id="err_ename"><?php echo $err_ename; ?></span> </td></tr>
