...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	echo "<br><b>Booking for the Eid event has been completed.You are invited.</b>";
	echo "<br><h4 style='color:red'>Time: 25th June to 5th July; 7.30 PM to 11.00 PM </h4>";
	}
}
...
<html>
	...
	<h1 style="color:green" align = "center"> Book For The 'Eid' Event</h1>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<img height="300px" width="400px" src="Eid2.jpg">
	</body>
</html>