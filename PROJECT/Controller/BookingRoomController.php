<?php
		...
		if(!$hasError)
		{
		$rs = insertRoom($RoomNo,$Branch,$NID,$Address,$Email,$Phone,$CIT,$COT);
	...
	function insertRoom($RoomNo,$Branch,$NID,$Address,$Email,$Phone,$CIT,$COT){
	$query="insert into bookingrooms values (NULL,'$RoomNo','$Branch','$NID','$Address','$Email','$Phone','$CIT','$COT')";
