<?php
	...
	else if(isset($_POST["Edit_CustomerByAdmin"]))
	{
		...
		if(!$hasError){
			$rs= updateCustomer($name,$userName,$email,$PhoneNumber,$NID,$Address,$gender,$age,$id);
			if($rs === true)
			{
	...
	else if(isset($_POST["Edit_CustomerByCustomer"]))
	{
		...
		if(!$hasError){
			$rs= updateCustomerByOwn($name,$userName,$email,$PhoneNumber,$NID,$Address,$gender,$age,$id);
			if($rs === true)
			{
	...
	function updateCustomerByOwn($name,$userName,$email,$PhoneNumber,$NID,$Address,$gender,$age,$image,$id)
	{
		$query = "update customers set name ='$name',userName = '$userName',email = '$email',phoneNumber ='$PhoneNumber',nidNo='$NID',address='$Address',gender='$gender',age='$age',image='$image' where customerId = '$id'";
		return execute($query);
	}
	
	function updateCustomer($name,$userName,$email,$PhoneNumber,$NID,$Address,$gender,$age,$image,$id)
	{
		$query = "update customers set name ='$name',userName = '$userName',email = '$email',phoneNumber ='$PhoneNumber',nidNo='$NID',address='$Address',gender='$gender',age='$age',image='$image' where customerId = '$id'";
		return execute($query);
	}
	...
	{
		$query="select * from customers where name like '%$key%'";
		$rs= get($query);
		return $rs;
	}
