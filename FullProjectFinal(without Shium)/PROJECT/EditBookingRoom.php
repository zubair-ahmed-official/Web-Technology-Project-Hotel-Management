...
<table style="border-color:green; width:40%; height:50%;" align="center" border="4">
	...
	<tr>
				<td colspan="2" align="center"><h1><b>Edit <?php echo $_SESSION["Booking Rooms"];?></b></h1></td>
	...
	<tr>				<input type="hidden" name="id" value=<?php echo $id;?>>
					...
					<tr>
						<td align="center" colspan="2"><input name="EditRoom" type="submit" value="Edit"></td>
				   
						</td>
					</tr>
					<tr>
				<td align="center" colspan="2"><input name="DeleteRoom" type="submit" value="Cancel Booking"></td>
				</tr>
			</form>
		</table>
